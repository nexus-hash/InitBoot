all:
	...
	i686-elf-gcc -g -m32  -Wl,--build-id=none -T link.ld -o kernel.elf -ffreestanding -nostdlib lowlevel.o main.o idt_int.o theme.o common.o monitor.o keyb.o boot.o -lgcc
